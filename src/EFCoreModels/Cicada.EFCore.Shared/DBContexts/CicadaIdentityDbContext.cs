...
{
    public class CicadaIdentityDbContext : IdentityDbContext<UserIdentity, UserIdentityRole, string, UserIdentityUserClaim, UserIdentityUserRole, UserIdentityUserLogin, UserIdentityRoleClaim, UserIdentityUserToken>
    {
        public CicadaIdentityDbContext(DbContextOptions<CicadaIdentityDbContext> options) : base(options)
        {
