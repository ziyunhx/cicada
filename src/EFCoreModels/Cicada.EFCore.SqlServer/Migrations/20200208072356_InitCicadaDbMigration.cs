        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnableView = table.Column<byte>(type: "tinyint(4)", nullable: false, defaultValueSql: "'1'"),
                    ...
                    CreateTime = table.Column<byte[]>(type: "timestamp", nullable: false, defaultValueSql: "'2000-01-01 00:00:00'"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdateTime = table.Column<byte[]>(type: "timestamp", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndTime = table.Column<byte[]>(type: "timestamp", nullable: true),
                    ...
                    NextRunTime = table.Column<byte[]>(type: "timestamp", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BeginTime = table.Column<byte[]>(type: "timestamp", nullable: false),
                    EndTime = table.Column<byte[]>(type: "timestamp", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateTime = table.Column<byte[]>(type: "timestamp", nullable: false),
                    Status = table.Column<int>(type: "int(11)", nullable: false),
                    ReplyMsg = table.Column<string>(type: "varchar(2048)", nullable: true),
                    ReplyTime = table.Column<byte[]>(type: "timestamp", nullable: false),
