...
namespace Cicada.EFCore.SqlServer.Extensions
{
    public static class DatabaseExtensions
    {
        ...
        public static void RegisterSqlServerDbContexts<TIdentityDbContext, TCicadaContext>(this IServiceCollection services, string cicadaConnectionString, string identityConnectionString)
            ...
            where TCicadaContext : CicadaDbContext
        {
            ...
            services.AddDbContext<CicadaDbContext>(options =>
                options.UseSqlServer(cicadaConnectionString, sql => sql.MigrationsAssembly(migrationsAssembly)));
        }
    }
}
