...
namespace Cicada.EFCore.PostgreSQL.Extensions
{
    public static class DatabaseExtensions
    {
        ...
        public static void RegisterNpgSqlDbContexts<TIdentityDbContext, TCicadaContext>(this IServiceCollection services, string cicadaConnectionString, string identityConnectionString)
            ...
            where TCicadaContext : CicadaDbContext
        {
            ...
            services.AddDbContext<CicadaDbContext>(options =>
                options.UseNpgsql(cicadaConnectionString, sql => sql.MigrationsAssembly(migrationsAssembly)));
        }
    }
}
